...
const footerLinks: FooterSection[] = [
  ...
  },
  {
    label: 'Social Links',
    links: [
      { title: 'Facebook', href: '/facebook', icon: FacebookIcon },
      { title: 'Instagram', href: '/instagram', icon: InstagramIcon },
          ...
          {footerLinks.map((section, index) => (
            <AnimatedContainer key={section.label} delay={0.1 + index * 0.1}>
              <div className="mb-10 md:mb-0">
                <h3 className="text-[10px] sm:text-xs uppercase tracking-wider text-slate-500 font-semibold">{section.label}</h3>
