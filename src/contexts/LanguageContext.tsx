...
const translations = {
  en: {
    ...
    'dashboard.rankingPosition': 'Ranking Position',
    ...
    'analysis.aiPromptAnalysis': 'AI Prompt Analysis',
    'analysis.promptMetricsSubtitle': 'Aggregated metrics by LLM and ranking by prompt',
    'analysis.highlights': 'Highlights',
    'analysis.recommendations.subtitle': 'Top suggestions for this domain',
    'analysis.empty.prompts': 'Not enough prompt data yet.',
    'analysis.empty.recommendations': 'No recommendations available.',
    'analysis.empty.insights': 'No strategic insights available.',
  ...
  'pt-BR': {
    ...
    'dashboard.rankingPosition': 'Posição no Ranking',
    ...
    'analysis.aiPromptAnalysis': 'Análise de Prompts de IA',
    'analysis.promptMetricsSubtitle': 'Métricas agregadas por LLM e ranking por prompt',
    'analysis.highlights': 'Destaques',
    'analysis.recommendations.subtitle': 'Principais sugestões para o domínio',
    'analysis.empty.prompts': 'Ainda não há dados suficientes de prompts.',
    'analysis.empty.recommendations': 'Sem recomendações disponíveis.',
    'analysis.empty.insights': 'Sem insights estratégicos disponíveis.',
