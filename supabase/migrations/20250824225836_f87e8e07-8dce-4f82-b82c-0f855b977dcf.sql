...
-- Drop and recreate the profiles UPDATE policy to prevent unauthorized role changes
DROP POLICY IF EXISTS "Users can update their own profile" ON public.profiles;

-- Only allow users to update their own non-role fields, and only admins can update roles
